...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="breadcrumb-title pe-3">Add Buy/Sell</div>
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Buy/Sell</li>
                    </ol>
                </nav>
            </div>
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form id="myForm" method="post" action="{{ route('store.buySell') }}"
